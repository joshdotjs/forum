              ...
              :
                <div className="border-t border-gray-700 pb-3">
                  <div className="mt-3 space-y-1 px-2 sm:px-3">
                    <Link
                      to={routes.login()}
                      className="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white cursor-pointer text-indigo-400 hover:text-indigo-300"
                    >
                      Log In
                    </Link>
                  </div>
